...
def visualizar_datos(
    ...
    plt.tight_layout()
    plt.savefig(salida / "01_distribucion_variable_objetivo.png")
    plt.close()

    # 2. Tipo de contacto vs aceptación
    plt.figure(figsize=(6, 4))
    ...
    plt.tight_layout()
    plt.savefig(salida / "02_contacto_vs_objetivo.png")
    plt.close()

    # 3. Edad vs aceptación
    plt.figure(figsize=(7, 4))
    sns.boxplot(x="y", y="age", data=df)
    plt.title("Distribución de la edad según aceptación")
    plt.xlabel("¿Contrató un depósito a plazo?")
    plt.ylabel("Edad")
    plt.tight_layout()
    plt.savefig(salida / "03_edad_vs_objetivo.png")
    plt.close()

    # 4. Campaign vs aceptación
    plt.figure(figsize=(7, 4))
    sns.boxplot(x="y", y="campaign", data=df)
    plt.title("Cantidad de contactos vs aceptación")
    plt.xlabel("¿Contrató un depósito a plazo?")
    plt.ylabel("Cantidad de contactos")
    plt.tight_layout()
    plt.savefig(salida / "04_campaign_vs_objetivo.png")
    plt.close()

    # 5. Resultado de campañas previas
    plt.figure(figsize=(7, 4))
    ...
    plt.legend(title="Contrató depósito")
    plt.tight_layout()
    plt.savefig(salida / "05_poutcome_vs_objetivo.png")
    plt.close()

    # 6. Duración de llamada vs aceptación (exploratorio)
    plt.figure(figsize=(7, 4))
    ...
    plt.tight_layout()
    plt.savefig(salida / "06_duration_vs_objetivo.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(salida / "07_matriz_correlacion.png")
    plt.close()

    # 8. Tasa de aceptación por mes
    tasa_mes = (
        df.groupby("month")["y"]
    ...
    plt.tight_layout()
    plt.savefig(salida / "08_tasa_aceptacion_por_mes.png")
    plt.close()
